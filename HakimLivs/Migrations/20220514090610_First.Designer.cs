...
namespace HakimLivs.Migrations
{
    ...
    [Migration("20220514090610_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HakimLivs.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HakimLivs.Models.Basket", b =>
                {
                    ...
                    b.HasOne("HakimLivs.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("HakimLivs.Models.Order", b =>
                {
                    b.HasOne("HakimLivs.Data.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HakimLivs.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
